...
class TestOrderBookDetails(unittest.TestCase):
    """OrderBookDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderBookDetails:
        """Test OrderBookDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderBookDetails`
        """
        ...
        if include_optional:
            return OrderBookDetails(
                ...
                message = '',
                order_book_details = [
                    lighter.models.order_book_detail.OrderBookDetail(
                        symbol = 'ETH', 
                        market_id = 1, 
                        status = 'active', 
                        taker_fee = '0.0001', 
