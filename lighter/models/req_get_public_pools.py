...
class ReqGetPublicPools(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["filter", "index", "limit", "account_index"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ReqGetPublicPools) in the input: " + _key)
